...
public class Cocktail implements Parcelable {
    ...
    public Cocktail(String idDrink, String name, String category, String alcoholic, String glass,
                    String instructions, String thumbnail, String ingredient1, String ingredient2,
                    ...
                    String ingredient15, String measure1, String measure2, String measure3, String measure4,
                    String measure5, String measure6, String measure7, String measure8, String measure9,
                    String measure10, String measure11, String measure12, String measure13, String measure14,
                    String measure15, String dateModified) {
    ...
    public Cocktail(String idDrink, String name, String category, String alcoholic, String glass,
                    String instructions, String thumbnail, String ingredient1, String dateModified){
        this.idDrink = idDrink;
        this.name = name;
        this.category = category;
        this.alcoholic = alcoholic;
    ...
    public List<String> getIngredientMeasureList() {
        ...
        if(ingredient1 != null && !ingredient1.isEmpty()){
            if(measure1 != null && !measure1.isEmpty()){
                ...
                listIngredientMeasureList.add(ingredient1 + " ");
            }
        }
        if(ingredient2 != null && !ingredient2.isEmpty()){
            if(measure2 != null && !measure2.isEmpty()) {
                ...
                listIngredientMeasureList.add(ingredient2 + " ");
            }
        }
        if(ingredient3 != null && !ingredient3.isEmpty()){
            if(measure3 != null && !measure3.isEmpty()) {
                ...
                listIngredientMeasureList.add(ingredient3 + " ");
            }
        }
        if(ingredient4 != null && !ingredient4.isEmpty()){
            if(measure4 != null && !measure4.isEmpty()) {
                ...
                listIngredientMeasureList.add(ingredient4 + " ");
            }
        }
        if(ingredient5 != null && !ingredient5.isEmpty()){
            if(measure5 != null && !measure5.isEmpty()) {
                ...
                listIngredientMeasureList.add(ingredient5 + " ");
            }
        }
        if(ingredient6 != null && !ingredient6.isEmpty()){
            if(measure6 != null && !measure6.isEmpty()) {
                ...
                listIngredientMeasureList.add(ingredient6 + " ");
            }
        }
        if(ingredient7 != null && !ingredient7.isEmpty()){
            if(measure7 != null && !measure7.isEmpty()) {
                ...
                listIngredientMeasureList.add(ingredient7 + " ");
            }
        }
        if(ingredient8 != null && !ingredient8.isEmpty()){
            if(measure8 != null && !measure8.isEmpty()) {
                ...
                listIngredientMeasureList.add(ingredient8 + " ");
            }
        }
        if(ingredient9 != null && !ingredient9.isEmpty()){
            if(measure9 != null && !measure9.isEmpty()) {
                ...
                listIngredientMeasureList.add(ingredient9 + " ");
            }
        }
        if(ingredient10 != null && !ingredient10.isEmpty()){
            if(measure10 != null && !measure10.isEmpty()) {
                ...
                listIngredientMeasureList.add(ingredient10 + " ");
            }
        }
        if(ingredient11 != null && !ingredient11.isEmpty()){
            if(measure11 != null && !measure11.isEmpty()) {
                ...
                listIngredientMeasureList.add(ingredient11 + " ");
            }
        }
        if(ingredient12 != null && !ingredient12.isEmpty()){
            if(measure12 != null && !measure12.isEmpty()) {
                ...
                listIngredientMeasureList.add(ingredient12 + " ");
            }
        }
        if(ingredient13 != null && !ingredient13.isEmpty()){
            if(measure13 != null && !measure13.isEmpty()) {
                ...
                listIngredientMeasureList.add(ingredient13 + " ");
            }
        }
        if(ingredient14 != null && !ingredient14.isEmpty()){
            if(measure14 != null && !measure14.isEmpty()) {
                ...
                listIngredientMeasureList.add(ingredient14 + " ");
            }
        }
        if(ingredient15 != null && !ingredient15.isEmpty()){
            if(measure15 != null && !measure15.isEmpty()) {
                ...
                listIngredientMeasureList.add(ingredient15 + " ");
            }
        }
